import { MemberSummary, Contribution, InvestmentFund, PortfolioAllocation, EmployerSummary, ManagedEmployee, ContributionPeriod, EmployerProfile } from './types';
...
export const MOCK_EMPLOYER_PROFILE: EmployerProfile = {
  companyName: 'Cloudflare HK',
  businessRegistrationNumber: '12345678-000-00-24-1',
  contactPerson: 'Human Resources',
  contactEmail: 'hr@cloudflare.hk',
